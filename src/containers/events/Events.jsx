...
//       gsap.set(plane1.current, { x: `+=${xForce * 0.3}`, y: `+=${yForce * 0.3}` });
...
//         <img src='/assets/images/events_images/T1.jpg' id='i1' alt="eventone" ref={plane1} ></img>
//         </div>
//         <div className="event_images" >
//         <img src="/assets/images/events_images/T2.jpg" id='i2'alt="eventtwo" ref={plane2}></img></div>
//         <div className="event_images">
//         <img src="/assets/images/events_images/group.jpeg" id='i3'alt="eventthree" ref={plane3}></img></div>
//         <div className="event_images">
//         <img src="/assets/images/events_images/red.jpg"id='i4' alt="eventone"ref={plane1} ></img></div>
//         <div className="event_images"ref={plane2}>
//         <img src="/assets/images/events_images/moon.jpg"id='i5' alt="eventtwo" ></img>
//         </div>
//         <div className="event_images"ref={plane3}>
//         <img src="/assets/images/events_images/Image_10.jpg" id='i6'alt="eventthree" ></img>
//         </div>
//         <div className="event_images"ref={plane1}>
    ...
    return (
        <>
            ...
            <div className='eventscontainer-mobile'>
                ...
                <div className="Events-container">
                    {['T1.jpg', 'T2.jpg', 'group.jpeg', 'red.jpg', 'moon.jpg', 'Image_10.jpg', 'eve.jpg', 'telescope.jpg'].map((src, index) => (
                        <div className="event_images" key={index}>
                            <img
                            id={`i${index+1}`}
                                src={`/assets/images/events_images/${src}`}
                                alt={`event${index}`}
...
function Event() {
    ...
    const animate = () => {
        ...
        planes.current.forEach((plane, index) => {
            if (plane) {
                // Assigning different movement factors for each image
